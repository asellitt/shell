...
module_install() {
  log "osx" "Installing macOS config"
  ...
  mkdir -p "$app_dir"
  link "${app_dir}/Lock.app"     "${osx_app_dir}/Lock.app"
  link "${app_dir}/Logout.app"   "${osx_app_dir}/Logout.app"
  link "${app_dir}/Restart.app"  "${osx_app_dir}/Restart.app"
  link "${app_dir}/Shutdown.app" "${osx_app_dir}/Shutdown.app"
  link "${app_dir}/Sleep.app"    "${osx_app_dir}/Sleep.app"

  log "osx" "Restarting system services"
