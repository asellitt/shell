...
if [ `uname` != 'Darwin' ]; then
  ...
  if [ ! -d "${SUBLIME_INSTALL_DIR}" ]; then
      ...
      link "${SUBLIME_USER_PACKAGE_DIR}/Package Control.sublime-settings" "${SUBLIME_USER_PACKAGE_DIR}/Package Control.sublime-settings"
      link "${SUBLIME_USER_PACKAGE_DIR}/Preferences.sublime-settings" "${SUBLIME_USER_PACKAGE_DIR}/Preferences.sublime-settings"
      log "   Installing User Macros"
      link "${SUBLIME_USER_PACKAGE_DIR}/pry_binding.sublime-macro" "${SUBLIME_USER_PACKAGE_DIR}/pry_binding.sublime-macro"
      link "${SUBLIME_USER_PACKAGE_DIR}/show_me_the_page.sublime-macro" "${SUBLIME_USER_PACKAGE_DIR}/show_me_the_page.sublime-macro"
      log "   Installing User Snippets"
      link "${SUBLIME_USER_PACKAGE_DIR}/ruby_do_end.sublime-snippet" "${SUBLIME_USER_PACKAGE_DIR}/ruby_do_end.sublime-snippet"
      link "${SUBLIME_USER_PACKAGE_DIR}/ruby_do_variable_end.sublime-snippet" "${SUBLIME_USER_PACKAGE_DIR}/ruby_do_variable_end.sublime-snippet"
      log "   Installing Syntax Highlighter"
      link "${SUBLIME_MODULE_DIR}/syntax_highlighting.py" "${SUBLIME_USER_PACKAGE_DIR}/syntax_highlighting.py"
